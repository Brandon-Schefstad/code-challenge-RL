...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    todos<T extends User$todosArgs= {}>(args?: Subset<T, User$todosArgs>): PrismaPromise<Array<TodoGetPayload<T>>| Null>;
  ...
  export type TodoGetPayload<S extends boolean | null | undefined | TodoArgs> =
    ...
    : S extends { select: any } & (TodoArgs | TodoFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :  P extends keyof Todo ? Todo[P] : never
  } 
      : Todo
